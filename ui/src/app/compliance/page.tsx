      ...
      <div className="space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <Link
            ...
            className="text-sm text-[#5cc15c] hover:underline inline-flex items-center gap-1"
          >
...
export default function CompliancePage() {
  return (
    <Suspense fallback={<div className="p-8 text-center text-muted-foreground">Loading compliance...</div>}>
