...
export class RunController {
  async createRun(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      res.status(500).json({ error: 'Failed to create run', message: (err as Error).message });
    }
  }
  ...
  async getRun(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      res.status(500).json({ error: 'Failed to get run', message: (err as Error).message });
    }
  }
  ...
  async updateRun(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      res.status(500).json({ error: 'Failed to update run', message: (err as Error).message });
    }
  }
  ...
  async listRuns(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      res.status(500).json({ error: 'Failed to list runs', message: (err as Error).message });
    }
  }
}
